...
import sqlite3
conn = sqlite3.connect('einastodark.db')    #Here I will create a database of thousands of darkmatters

c = conn.cursor()   #my cursor

# Create table
c.execute('''CREATE TABLE einasto135low
...
for x in list_of_darkhalos:
	...
	query_string = 'INSERT INTO einasto135low VALUES (%s);' % halo_string
